const github = "https://github.com/diego-girao"
		...
		<footer className="footer place-items-end p-4 bg-neutral text-neutral-content">
			...
			<div className="grid-flow-col gap-2 justify-self-center md:items-center md:place-self-center md:justify-self-end">
				...
				<a
					href={github}
					target="_blank"
					aria-label="Saiba sobre o projeto e outros mais"
				>
					<svg
				...
				<a
					href="mailto:diegoramiro25@gmail.com"
					aria-label="Send an e-mail to developer"
				>
					<svg
